    ...
    <div className="bg-indigo-700">
      <div className="max-w-4xl mx-auto px-4 py-16 sm:px-6 sm:pt-20 sm:pb-24 lg:max-w-7xl lg:pt-24 lg:px-8">
        ...
        <p className="mt-4 max-w-3xl text-lg text-indigo-200">
          We're generating more data every day, in the journey to the quantified
          self. But we don't know how our data is used, or even if we'll end up
          in an ad. Use Oltiva Actif to control your data, and know how it's
          used - privacy is healthy.
        </p>
